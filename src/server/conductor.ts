...
type AutonInfo = { uri: string; funcName: string; index: number };
/**
...
export class Conductor {
  ...
  protected getAuton(
    ...
    if (!auton) throw "this.currAuton is undefined";
  ...
  private eventListeners = new (class EventListeners {
    ...
    private async onWebviewAutonEdit(edit: AutonEdit.Result.Modify<Action>) {
      ...
      if (!this.conductor.currAuton) throw "conductor.currAuton is undefined";
  ...
  private _onDidChangeCurrentAuton = new SignalDispatcher();
